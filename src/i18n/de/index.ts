...
export default {
    ...
    translation: {
        ...
        lookup: 'Lookup',
        mailUs: 'Wir sind gerne <a href="mailto: support@sms77.io">via E-Mail</a> erreichbar.',
        ok: 'OK',
        onePlusRecipient: 'Empfänger getrennt durch Komma',
        options: 'Optionen',
        pleaseSetApiKey: 'Bitte den API-Schlüssel von sms77.io setzen.',
        pricing: 'Preise',
        ...
        sms: 'SMS',
        socialsBtnGroup: 'Sms77 in sozialen Medien',
        support: 'Support',
