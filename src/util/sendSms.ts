import {Client, SmsParams, SmsResource, SmsResponse} from '@seven.io/client'
...
type CommonMessageProps = Pick<SmsParams, CommonMessagePropKeys>
type MessageDispatchProps<T> = T & CommonMessageProps
